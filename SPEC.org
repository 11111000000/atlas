...
- Визуализация: Atlas Entities (дерево сущностей)
  ...
  - Иконки: у каждого узла отображается иконка по типу элемента (feature/file/symbol-kind); тема иконок настраивается.
  - Клавиши: g — refresh; RET/o — открыть; TAB — fold/unfold; p — peek; s — search view; E — edges view; P — plan view; i — follow-mode; a — меню действий (transient при наличии).
